# Obtained from https://github.com/UFO-101/auto-circuit/blob/main/datasets/ioi/ioi_generator.py
# which was based on:
...
# NAMES have been modified to better suit tinystories
#%%
...
NAMES = [
    'Lily', 'Tim', 'Ben', 'Tom', 'Max', 'Sam', 'Anna', 'Jack', 'Mia', 'Sara', 
    'Lucy', 'Bob', 'Sue', 'Sarah', 'Jane', 'John', 'Joe', 'Benny', 'Sally', 
    'Daisy', 'Tommy', 'Billy', 'Amy', 'Molly', 'Jill', 'Mary', 'Emma', 'Sammy', 
    'Jimmy', 'Emily', 'Jen', 'Jenny', 'Jake', 'Jim', 'Lisa', 'Teddy', 'Peter', 
    'Johnny', 'Leo', 'Mark', 'Bobby', 'Ellie', 'Pete', 'Rose', 'Fred', 'Bella', 
    'Alice', 'Mike', 'Ann', 'Dave', 'Bill', 'Kim', 'Toby', 'George', 'Polly', 
    'Sophie', 'Jerry', 'Joey', 'Alex', 'Andy', 'Paul', 'Ted', 'Maria', 'Buzz', 
    'Annie', 'Sandy', 'Lilly', 'Grace', 'Charlie', 'Henry', 'Pat', 'Jo', 'Kate', 
    'Tony', 'Danny', 'Harry', 'Freddy', 'Clara', 'Zoe', 'James', 'Tina', 'Dan', 
    'Betsy', 'Ruby', 'Maggie', 'Joy', 'Steve', 'Remy', 'Rachel', 'Luna', 'Liz', 
    'Katie', 'May', 'David', 'Penny', 'Beth', 'Rob', 'Julie', 'Thomas', 'Pip'
]
...
for order in ["mixed"]:
    ...
    path = "../datasets/autocircuit_ioi_customized_prompts.json"
